...
GAME_SIM = {
    ...
    "pchc-r-p-i": PPHC_SIM(mutation = "resample", cand_selection="pareto_select", test_selection="informativeness_select"), 
    "pchc-r-p-p": PPHC_SIM(mutation = "resample", cand_selection="pareto_select", test_selection="pareto_select"),
